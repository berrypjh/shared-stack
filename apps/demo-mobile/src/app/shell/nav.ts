 ...
 * 정보 구조.
 *
 * 섹션을 전부 한 스크롤에 쌓으면 본문이 수백 줄로 늘어 원하는 컴포넌트를 찾기 어렵습니다.
 * 그래서 목록 → 상세로 나누고, 그룹은 컴포넌트의 종류를 따릅니다 — 입력 / 액션 / 배치 /
 * identity / foundation. demo-web 사이드바와 같은 나눔이 아닙니다: 그쪽은 Storybook 이
 * 컴포넌트 전체를 담당해서 작업 단위로 갈리고, 여기는 컴포넌트 전체가 이 목록에 올라옵니다.
 *
